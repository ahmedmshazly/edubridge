...
var g = async ({ elementReference: e2 = null, tooltipReference: t2 = null, tooltipArrowReference: o2 = null, place: r2 = "top", offset: l2 = 10, strategy: n2 = "absolute", middlewares: c2 = [offset(Number(l2)), flip2({ fallbackAxisSideDirection: "start" }), shift2({ padding: 5 })], border: i2 }) => {
  if (!e2)
