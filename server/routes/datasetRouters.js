...
const { addDataset, getDatasetsByUser, getDatasetDetails, deleteDataset, getDatasetsNamesIdByUser } = require('../controllers/datasetController');
...
router.get('/names', getDatasetsNamesIdByUser);
